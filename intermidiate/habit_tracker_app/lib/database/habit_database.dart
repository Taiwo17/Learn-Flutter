...
class HabitDatabase extends ChangeNotifier {
  ...
  // Save first date of the app startup (for heatmap)
  ...
  // Get first date of the app startup (for heatmap)
  ...
  */
  ...
  Future<void> readHabit() async {
    // fetch all the habit from db
    List<Habit> fetchedHabits = await isar.habits.where().findAll();

    // give it to current habit
    currentHabits.clear();
  ...
  Future<void> updateHabitCompletion(int id, bool isCompleted) async {
    ...
    if (habit != null) {
      await isar.writeTxn(
        () async {
          // if habit is completed -> add the current date to the completedDay list
